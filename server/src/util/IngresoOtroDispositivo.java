...
public class IngresoOtroDispositivo extends Thread {
    ...
    private static final String PathFile = "emails/IngresoOtroDispositivo.html";

    public IngresoOtroDispositivo(JSONObject data) {
        this.data = data;
    }
