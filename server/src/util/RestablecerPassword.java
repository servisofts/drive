...
public class RestablecerPassword extends Thread {
    ...
    private static final String PathFile = "emails/RestablecerPassword.html";

    public RestablecerPassword(JSONObject data) {
        this.data = data;
    }
	...
	public static void main(String[] args) {
        ...
        obj.put("pass", "ABDBSC");
        //se envia
        new RestablecerPassword(obj).start();
    }
