            ...
            <View style={{ ...styles.container, ...containerStyle, flexDirection: "row" }}>
                <TouchableOpacity onPress={() => this.showModal()}>
                    <View style={{
                        ...
                        <Text style={[styles.flagStyle, flagStyle, { color: STheme.color.text }]}>{flag}</Text>
                        <Text style={[styles.dialCodeTextStyle, dialCodeTextStyle, { color: STheme.color.text }]}>{this.state.dialCode}</Text>
                    </View>
                </TouchableOpacity>
                <TextInput
                    {...inputProps}
                    ...
                    placeholder={this.props.placeholder || this.state.mask.replace(/9/g, '')}
                    autoCorrect={false}
